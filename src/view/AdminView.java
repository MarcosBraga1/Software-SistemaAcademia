...
/**
 * Classe que armazena o método da view da administração.
 * 
 * <p>Essa classe é responsável por possuir um método que cria a view para o sistema
 * de um usuário administrador do sistema.</p>
 * @author Marcos
 */
public class AdminView {
    ...
    // Método
    /**
     * Método responsável por criar a view do sistema para um usuário administrador.
     */
    public void adminView(){
        ...
        while(true){
            ...
            System.out.println("-----Funcoes Admin-----");
            ...
            switch (resposta){
                ...
                case 6:
                    ...
                    while (aux6){
                        ...
                        System.out.println("[1] - Ver Funcionarios Cadastrados");
                        ...
                        switch (escolha6){
                            ...
                            case 1:
                                gf.percorrerFuncionariosForEach();
                                break;
                            ...
                            case 2:
                                ...
                                System.out.println("Insira o usuario de login: ");
                                scanner.nextLine();
                                String usuario = scanner.nextLine();

                                System.out.println("Insira a senha de login: ");
                                String senha = scanner.nextLine();

                                gf.cadastrarFuncionario(nome,cpf,endereco,email,telefone, cargo, usuario, senha);
                                break;
                            ...
                            case 3:
                                ...
                                if (gf.retornarFuncionario(input1)== null){
                                    break;
                                }

                                Funcionario f1 = gf.retornarFuncionario(input1);
                                System.out.println("Nome: " + f1.getNome() + "\nInsira um novo valor: ");
                                scanner.nextLine();
                                String f1Nome = scanner.nextLine();
                                System.out.println("CPF: " + f1.getCpf() + "\nInsira um novo valor: ");
                                String f1Cpf = scanner.nextLine();
                                System.out.println("Endereco: " + f1.getEndereco() + "\nInsira um novo valor: ");
                                String f1Endereco = scanner.nextLine();
                                System.out.println("Email: " + f1.getEmail() + "\nInsira um novo valor: ");
                                String f1Email = scanner.nextLine();
                                System.out.println("Telefone: " + f1.getTelefone() + "\nInsira um novo valor: ");
                                String f1Telefone = scanner.nextLine();
                                System.out.println("Cargo: " + f1.getCargo() + "\nInsira um novo cargo: ");
                                System.out.println("[1] - Funcionario");
                                System.out.println("[2] - Gerente");
                                int f1Cargo = scanner.nextInt();
                                System.out.println("Usuario: " + f1.getUsuario() + "\nInsira um novo usuario: ");
                                scanner.nextLine();
                                String f1Usuario = scanner.nextLine();
                                System.out.println("Senha: " + f1.getSenha() + "\nInsira um novo senha: ");
                                String f1Senha = scanner.nextLine();

                                gf.atualizarFuncionario(f1, f1Nome, f1Cpf, f1Endereco, f1Email, f1Telefone, f1Cargo, f1Usuario, f1Senha);
                                break;
